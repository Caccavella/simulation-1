    ...
    render() {
        return (
            <div>
                ...
                <div className="binsA">
                <Link to="/bins/A1" className='bin' >{Bin1} Bin 1</Link>
                <Link to="/bins/A2" className='bin' >{Bin2} Bin 2</Link>
                <Link to="/bins/A3" className='bin' >{Bin3}Bin 3</Link>
                <Link to="/bins/A4" className='bin' >{Bin4}Bin 4</Link>
                <Link to="/bins/A5" className='bin' >{Bin5}Bin 5</Link>
